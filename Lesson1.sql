--- Limits
/*
Try using LIMIT yourself below by writing a query that displays all
the data in the occurred_at, account_id, and channel columns of the
 web_events table, and limits the output to only the first 15 rows.
 */
...
poster_amt_usd / (standard_amt_usd + poster_amt_usd + gloss_amt_usd)*100 AS poster_revenue_percent
FROM orders
LIMIT 10;
